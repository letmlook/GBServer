...
(
    ...
    keepalive_time                      varchar(50) COMMENT '最近心跳时间',
...
(
    ...
    alarm_priority    varchar(50) COMMENT '报警级别',
    alarm_method      varchar(50) COMMENT '报警方式（视频/语音等）',
    alarm_time        varchar(50) COMMENT '报警发生时间',
    alarm_description varchar(255) COMMENT '报警描述',
