...
> 🔍 想了解当前接口实现状态与待补齐项？见 [`docs/INTERFACE_COVERAGE.md`](docs/INTERFACE_COVERAGE.md)。
...
| [docs/BACKEND_TESTING.md](docs/BACKEND_TESTING.md) | 后端测试体系说明 |
| [docs/BACKEND_TEST_SUMMARY.md](docs/BACKEND_TEST_SUMMARY.md) | 后端测试覆盖率与结果汇总 |
| [docs/TEST_REPORT.md](docs/TEST_REPORT.md) | 最新一次回归测试报告 |
| [docs/INTERFACE_COVERAGE.md](docs/INTERFACE_COVERAGE.md) | GB28181 接口实现状态与待补齐项 |
...
```bash
# 缺省 BASE_URL = http://localhost:18080
node scripts/api-integration-test.js
# 或指向远端
BASE_URL=http://your-host:18080 node scripts/api-integration-test.js
```

脚本会先登录取 token，再逐个请求主要接口并输出 OK/FAIL。
