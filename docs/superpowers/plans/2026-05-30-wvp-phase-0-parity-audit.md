...
- `docs/parity/wvp-phase-0-parity-audit.json`
  - Machine-readable audit output.

- `docs/parity/wvp-phase-0-parity-audit.md`
...
**Files:**
- Generate: `docs/parity/wvp-phase-0-parity-audit.json`
- Generate: `docs/parity/wvp-phase-0-parity-audit.md`
...
- `docs/parity/wvp-phase-0-parity-audit.json` is created.
- `docs/parity/wvp-phase-0-parity-audit.md` is created.
...
text = Path('docs/parity/wvp-phase-0-parity-audit.md').read_text()
...
import json
from pathlib import Path
report = json.loads(Path('docs/parity/wvp-phase-0-parity-audit.json').read_text())
...
```bash
git add docs/parity/wvp-phase-0-parity-audit.json docs/parity/wvp-phase-0-parity-audit.md
...
text = path.read_text()
notice = """# WVP 功能差距分析\n\n> **Current source of truth:** Phase 0 parity auditing is now generated by `scripts/parity-audit/extract-wvp-parity.js`. Review `docs/parity/wvp-phase-0-parity-audit.md` first for backend route, official frontend API, local frontend, and page-route gaps against the selected WVP-Pro baseline. The historical notes below remain useful context, but individual claims may be stale after later implementation.\n\n"""
if text.startswith('# WVP 功能差距分析'):
    rest = text.split('\n', 1)[1]
    path.write_text(notice + rest.lstrip('\n'))
elif 'docs/parity/wvp-phase-0-parity-audit.md' not in text:
...
needle = 'docs/parity/wvp-phase-0-parity-audit.md'
...
- Verify: `docs/parity/wvp-phase-0-parity-audit.md`
...
```bash
git diff -- docs/parity/wvp-phase-0-parity-audit.json docs/parity/wvp-phase-0-parity-audit.md
```
...
```bash
git checkout -- docs/parity/wvp-phase-0-parity-audit.json docs/parity/wvp-phase-0-parity-audit.md
```
