...
export function getRegionTreeList() {
  return request<ApiResult<Region[]>>({
    method: 'get',
...
export function getRegionTreeQuery(params: TreeNodeQueryParams = {}) {
  return request<ApiResult<TreeNodePage<Region>>>({
    method: 'get',
...
export function syncRegion() {
  return request<ApiResult<{ count: number }>>({
    method: 'get',
    url: '/region/sync'
  })
}
...
export function getGroupTreeList() {
  return request<ApiResult<Group[]>>({
    method: 'get',
    url: '/group/tree/list'
  })
}
...
export function getGroupTreeQuery(params: TreeNodeQueryParams = {}) {
  return request<ApiResult<TreeNodePage<Group>>>({
    method: 'get',
